...
namespace Common {
    ...
    */
    enum Rule_hash : U64 {
        ...
        SX = 637617821172976110ULL,
        SXdg = 14978707486506580347ULL,
        ...
        CRy = 17699984471013370139ULL,
        CRx = 17699983371501741928ULL,
        CVdg = 3686223304418618413ULL,
        CS = 622126801846138931ULL,
        CSdg = 1882660296283893622ULL,
        CSX = 17700834393501788017ULL,
        CSXdg = 13280167134260284376ULL,
        SWAP = 11860844353443772942ULL,
